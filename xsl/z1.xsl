  ...
  <xsl:template match="/">
    <fo:root>
      <fo:layout-master-set>
        <fo:simple-page-master master-name="Letter" page-width="8.5in" page-height="11in"
          ...
          padding="10pt" font-family="Arial, sans-serif" font-size="6pt">
          <fo:region-body />
      ...
      <fo:page-sequence master-reference="Letter">
        <fo:flow flow-name="xsl-region-body" font-size="10pt">
          <fo:block text-align="center" font-weight="bold" font-size="14pt"> ZAHTEV ZA PRIZNANJE
            ZIGA </fo:block>
          <fo:block text-align="center" font-weight="bold" space-after="10pt"> Zavodu za
    ...
    prezime/poslovno ime, ulica i broj, postanski broj, mesto, drzava prebivalista/sedista: </fo:block>
              ...
              <fo:table-row border-width="0.5px" border-style="solid">
                <fo:table-cell>
                  <fo:block>
                    <fo:inline font-weight="bold">2. Punomocnik:</fo:inline> ime i prezime/poslovno
    ime, ulica i broj, postanski broj, mesto, drzava prebivalista/sedista: </fo:block>
                </fo:table-cell>
              </fo:table-row>
              <fo:table-row border-width="0.5px" border-style="solid">
                <fo:table-cell>
                                        ...
                                        <fo:table-cell>
                                          <fo:table>
                                            <fo:table-column border-width="0.5px"
                                              border-style="solid" />
                                            <fo:table-column border-width="0.5px"
                                              border-style="solid" column-width="1cm" />
                                            <fo:table-body>
    ...
    X </xsl:when>
                                              ...
                                              <fo:table-row border-width="0.5px"
                                                ...
                                                <fo:table-cell>
                                                  <fo:block>
                                                    <fo:inline>drugu vrstu znaka (navesti koju)</fo:inline>
                                                    <xsl:value-of
                            ...
                            <fo:table-body>
                              ...
                              <fo:table-row>
                                <fo:table-cell>
                                  <fo:block>
                                    <xsl:apply-templates
                                      select="/zahtev_za_priznanje_ziga/podaci_o_zigu/izgled_znaka" />
                                  </fo:block>
                                </fo:table-cell>
                              </fo:table-row>
                            </fo:table-body>
                      ...
                      <fo:table-row border-width="0.5px" border-style="solid">
                        <fo:table-cell>
                          <fo:block space-after="10pt">
                            <fo:inline font-weight="bold">b) za <fo:inline
    ...
    da sadrzi jasne i precizne nazive robe i usluga. U tu svrhu mogu se koristiti pojmovi iz
              detaljne Liste robe i usluga ili MGS Manager aplikacije, dostupnih na sajtu Zavoda.
    Ukoliko se u
