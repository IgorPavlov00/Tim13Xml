	...
	<xsl:template match="/">
			...
			<body>
				...
				<div class="container">
					<table class="main">
						<tr>
							<td>
								<strong>1. Podnosilac prijave:</strong> ime i prezime/poslovno ime,
		ulica i broj, poštanski broj, mesto, država prebivališta/sedišta:</td>
						</tr>
						<tr>
							<td>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/licni_podaci/ime" />
									<xsl:text>&#x20;</xsl:text>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/licni_podaci/prezime" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/licni_podaci/adresa/ulica" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/licni_podaci/adresa/postanski_broj" />
									<xsl:text>&#x20;</xsl:text>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/licni_podaci/adresa/mesto" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/licni_podaci/adresa/drzava" />
								</p>
							</td>
						</tr>
						<tr>
							<td>
								<table>
									<tr>
										<td>telefon: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/telefon" />
										</td>
										<td>e-mail: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/email" />
										</td>
										<td>faks: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_podnosiocu/faks" />
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td>
								<strong>2. Punomoćnik:</strong> ime i prezime/poslovno ime, ulica i
		broj, poštanski broj, mesto, država prebivališta/sedišta:</td>
						</tr>
						<tr>
							<td>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/licni_podaci/ime" />
									<xsl:text>&#x20;</xsl:text>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/licni_podaci/prezime" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/licni_podaci/adresa/ulica" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/licni_podaci/adresa/postanski_broj" />
									<xsl:text>&#x20;</xsl:text>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/licni_podaci/adresa/mesto" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/licni_podaci/adresa/drzava" />
								</p>
							</td>
						</tr>
						<tr>
							<td>
								<table>
									<tr>
										<td>telefon: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/telefon" />
										</td>
										<td>e-mail: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/email" />
										</td>
										<td>faks: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_punomocniku/faks" />
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/licni_podaci/ime" />
									<xsl:text>&#x20;</xsl:text>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/licni_podaci/prezime" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/licni_podaci/adresa/ulica" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/licni_podaci/adresa/postanski_broj" />
									<xsl:text>&#x20;</xsl:text>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/licni_podaci/adresa/mesto" />
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/licni_podaci/adresa/drzava" />
								</p>
							</td>
						</tr>
						<tr>
							<td>
								<table>
									<tr>
										<td>telefon: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/telefon" />
										</td>
										<td>e-mail: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/email" />
										</td>
										<td>faks: <xsl:value-of
												select="/zahtev_za_priznanje_ziga/podaci_o_predstavniku/faks" />
										</td>
									</tr>
								</table>
							</td>
																...
																<td>
																	<table>
																		<tr>
																			...
																			<td
																				class="center x-field">
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_ziga/individualni_zig = true()">
		X </xsl:when>
																		...
																		<tr>
																			...
																			<td
																				...
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_ziga/kolektivni_zig = true()">
		X </xsl:when>
																					<xsl:otherwise></xsl:otherwise>
																				</xsl:choose>
																			</td>
																		...
																		<tr>
																			...
																			<td
																				...
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_ziga/zig_garancije = true()">
		X </xsl:when>
																					<xsl:otherwise></xsl:otherwise>
																				</xsl:choose>
																			</td>
														...
														<table>
															<tr>
																...
																<td>
																	<table>
																		<tr>
																			<td>verbalni znak (znak
																				u reči)</td>
																			<td
																				class="center x-field">
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_znaka/verbalni_znak = true()">
		X </xsl:when>
																					<xsl:otherwise></xsl:otherwise>
																				</xsl:choose>
																			</td>
		...
		kombinaciju
																			...
																			<td
																				...
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_znaka/graficki_znak = true()">
		X </xsl:when>
																					<xsl:otherwise></xsl:otherwise>
																				</xsl:choose>
																			</td>
																		...
																		<tr>
																			...
																			<td
																				...
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_znaka/kombinovani_znak = true()">
		X </xsl:when>
																					<xsl:otherwise></xsl:otherwise>
																				</xsl:choose>
																			</td>
																		...
																		<tr>
																			...
																			<td
																				...
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_znaka/trodimenzionalni_znak = true()">
		X </xsl:when>
																					<xsl:otherwise></xsl:otherwise>
																				</xsl:choose>
																			</td>
																		...
																		<tr>
																			<td>drugu vrstu znaka
		(navesti koju) <xsl:value-of
																					select="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_znaka/druga_vrsta" />
																			</td>
																			<td
																				class="center x-field">
																				<xsl:choose>
																					<xsl:when
																						test="/zahtev_za_priznanje_ziga/podaci_o_zigu/vrsta_znaka/drugo = true()">
		X </xsl:when>
																					<xsl:otherwise></xsl:otherwise>
																				</xsl:choose>
																			</td>
												...
												<tr>
													<td>
														...
														<p>
															<xsl:value-of
																select="/zahtev_za_priznanje_ziga/podaci_o_zigu/naznacenje_boje" />
														</p>
													</td>
												</tr>
												<tr>
													<td>
														...
														<p>
															<xsl:value-of
																select="/zahtev_za_priznanje_ziga/podaci_o_zigu/transliteracija" />
														</p>
													</td>
												</tr>
												<tr>
													<td>
														...
														<p>
															<xsl:value-of
																select="/zahtev_za_priznanje_ziga/podaci_o_zigu/prevod" />
														</p>
													</td>
												</tr>
												<tr>
													<td>
														...
														<p>
															<xsl:value-of
																select="/zahtev_za_priznanje_ziga/podaci_o_zigu/opis" />
														</p>
													</td>
												</tr>
											</table>
										...
										<td>
											<table>
												...
												<tr>
													<td style="height:150px;" class="imgTD">
														<img
															src="{/zahtev_za_priznanje_ziga/podaci_o_zigu/izgled_znaka}" />
							...
							<td>
								<table>
									<xsl:variable name="tokens"
										select="tokenize(/zahtev_za_priznanje_ziga/podaci_o_zigu/brojevi_klasa_robe_i_usluga, ',')" />
									<tr>
										<td class="center">
											<xsl:variable name="searchValue" select="'1'" />
											<xsl:choose>
												<xsl:when
													test="some $token in $tokens satisfies $token = $searchValue">
						...
						<tr>
							<td>
								...
								<p>
									<xsl:choose>
										<xsl:when
											test="/zahtev_za_priznanje_ziga/podaci_o_zigu/pravo_prvenstva/zatrazeno = true()">
		Jeste, osnov je </xsl:when>
										<xsl:otherwise>Nije zatrazeno</xsl:otherwise>
									</xsl:choose>
								</p>
								<p>
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_zigu/pravo_prvenstva/osnov" />
								</p>
							</td>
						</tr>
						<tr>
											...
											<table>
												...
												<tr>
													...
													<td>
														...
														<p>
															<xsl:value-of
																select="/zahtev_za_priznanje_ziga/podaci_o_placenoj_taksi/osnovna_taksa" />
														</p>
													</td>
												</tr>
												<tr>
													<td>
														<p>
															<strong>b) za <span class="underline">
																	<xsl:value-of
																		select="/zahtev_za_priznanje_ziga/podaci_o_zigu/brojevi_klasa_robe_i_usluga" />
																</span>
		klasa</strong>
														</p>
														<p>
													...
													<td>
														<p>
															<xsl:value-of
																select="/zahtev_za_priznanje_ziga/podaci_o_placenoj_taksi/za_klase" />
														</p>
														<p>
															<xsl:value-of
																select="/zahtev_za_priznanje_ziga/podaci_o_placenoj_taksi/za_graficko_resenje" />
														</p>
													</td>
												</tr>
												<tr>
													...
													<td>
														<xsl:value-of
															select="/zahtev_za_priznanje_ziga/podaci_o_placenoj_taksi/ukupno" />
													</td>
												</tr>
											</table>
										</td>
					...
					<table class="main">
						...
						<tr>
							...
							<td rowspan="9" class="center">
								...
								<p class="underline">
									<xsl:value-of
										select="/zahtev_za_priznanje_ziga/podaci_o_zahtevu/broj_prijave" />
								</p>
								<p>
								...
								<p class="underline">
									<strong>
										<xsl:value-of
											select="/zahtev_za_priznanje_ziga/podaci_o_zahtevu/datum_podnosenja" />
									</strong>
								</p>
								<br />
								<br />
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/primerak_znaka = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/spisak_robe_i_usluga = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/punomocje = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/ranije_prilozeno_punomocje = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/naknadno_dostavljeno_punomocje = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/opsti_akt_o_zigu = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/dokaz_o_pravu_prvenstva = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
						...
						<tr>
							...
							<td class="center x-field">
								<xsl:choose>
									<xsl:when
										test="/zahtev_za_priznanje_ziga/prilozi/dokaz_o_uplati_takse = true()">
		X </xsl:when>
									<xsl:otherwise></xsl:otherwise>
								</xsl:choose>
							</td>
					...
					<p style="text-align: justify;">**Uz zaokruživanje broja klase robe/usluga
