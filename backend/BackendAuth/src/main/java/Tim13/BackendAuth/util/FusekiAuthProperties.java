package Tim13.BackendAuth.util;
...
public class FusekiAuthProperties {
    /**
     * Read the configuration properties for the example.
     *
     * @return the configuration object
     */
    public static FusekiConnProperties loadProperties() throws IOException {
        ...
        return new FusekiConnProperties(props);
    }
    ...
    public static InputStream openStream(String fileName) throws IOException {
        return FusekiAuthProperties.class.getClassLoader().getResourceAsStream(fileName);
    }

    static public class FusekiConnProperties {
        ...
        public FusekiConnProperties(Properties props) {
            super();
